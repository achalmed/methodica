...
\title{Tipos de elementos y campos en Zotero}
...
\abstract{This publication provides a comprehensive guide to the item
types supported by Zotero, a widely used reference management tool. It
details the purpose, fields, and appropriate use of each item type, such
as Artwork, Book, Journal Article, and more, based on official Zotero
...
\hypersetup{
  pdftitle={Tipos de elementos y campos en Zotero},
  pdfauthor={Autor}
}
\makeatletter
...
\tableofcontents
\newpage
\section[Introduction]{Tipos de elementos y campos en Zotero}
...
Esta publicación proporciona una descripción detallada de los tipos de
elementos soportados por Zotero, basada en la documentación oficial de
Zotero.

\section{Artwork (Obra de arte)}\label{artwork-obra-de-arte}
...
\section{Audio Recording (Grabación de
...
\section{Bill (Proyecto de ley)}\label{bill-proyecto-de-ley}
...
\section{Blog Post (Entrada de blog)}\label{blog-post-entrada-de-blog}
...
\section{Book (Libro)}\label{book-libro}
...
\section{Book Section (Sección de
...
\section{Case (Caso legal)}\label{case-caso-legal}
...
\section{Conference Paper (Artículo en
...
\section{Dictionary Entry (Entrada de
...
\section{Document (Documento)}\label{document-documento}
...
\section{Email (Correo electrónico)}\label{email-correo-electruxf3nico}
...
\section{Encyclopedia Article (Artículo de
...
\section{Film (Película)}\label{film-peluxedcula}
...
\section{Forum Post (Publicación en
...
\section{Hearing (Audiencia)}\label{hearing-audiencia}
...
\section{Instant Message (Mensaje
...
\section{Interview (Entrevista)}\label{interview-entrevista}
...
\section{Journal Article (Artículo de revista
...
\section{Letter (Carta)}\label{letter-carta}
...
\section{Magazine Article (Artículo de
...
\section{Manuscript (Manuscrito)}\label{manuscript-manuscrito}
...
\section{Map (Mapa)}\label{map-mapa}
...
\section{Newspaper Article (Artículo de
...
\section{Patent (Patente)}\label{patent-patente}
...
\section{Podcast (Podcast)}\label{podcast-podcast}
...
\section{Radio Broadcast (Emisión de
...
\section{Report (Informe)}\label{report-informe}
...
\section{Software (Software)}\label{software-software}
...
\section{Statute (Ley)}\label{statute-ley}
...
\section{Thesis (Tesis)}\label{thesis-tesis}
...
\section{TV Broadcast (Emisión de
...
\section{Video Recording (Grabación de
...
\section{Webpage (Página web)}\label{webpage-puxe1gina-web}
...
\section{Attachment (Archivo adjunto)}\label{attachment-archivo-adjunto}
...
\section{Note (Nota)}\label{note-nota}
